...
<p>First, let’s explore more about how to use spring-data-jpa, I'll not going into details because you probably already know. If not, check [Spring Data reference](https://docs.spring.io/spring-data/jpa/docs/2.1.8.RELEASE/reference/html)</p>
